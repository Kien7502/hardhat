...
const poolContractAddress = '0xe7f3b441449694da149edfdf34605da59a53cd21';
let userPrivateKey = "";
if (userPrivateKey == "" && process.env.PRIVATE_KEY){
  userPrivateKey = process.env.PRIVATE_KEY; // Khóa riêng tư của người dùng
}
...
async function approveToken() {
  try {
    const gasPrice = await web3.eth.getGasPrice();
    const gasLimit = 200000; // Đặt giới hạn gas tùy ý
